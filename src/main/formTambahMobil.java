...
public class formTambahMobil extends javax.swing.JInternalFrame {
    
    private kendaraanIntrfc mobilCtr;
    
    validasi Valid = new validasi();
    
    public formTambahMobil() {
        initComponents();
        mobilCtr = new tambahMobil(this);
        mobilCtr.tampilkan_data();
    }
    ...
    public void setHarga(JTextField tfHarga) {
        this.tfHarga = tfHarga;
    }

    public void setMerk(JTextField tfMerk) {
        this.tfMerk = tfMerk;
    }

    public void setNopol(JTextField tfNopol) {
        this.tfNopol = tfNopol;
    }

    public void setSearch(JTextField tfSearch) {
        this.tfSearch = tfSearch;
    }

    public void setTipe(JTextField tfTipe) {
        this.tfTipe = tfTipe;
    }
